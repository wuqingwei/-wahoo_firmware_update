...
最新版本 2022-05-25 [14848](https://github.com/wuqingwei/-wahoo_firmware_update/blob/main/firmware/BoltApp14848.apk)
...
从项目仓库的文件列表中，[进入firmware目录](https://github.com/wuqingwei/-wahoo_firmware_update/tree/main/firmware)，所有的固件都采用
BoltApp + 版本号 + .apk
